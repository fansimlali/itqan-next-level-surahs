/**
 * SURAH_VERSES: عدد الآيات في كل سورة من القرآن الكريم */
...
export const SURAH_VERSES = {
  ...
  'يس': 83, 'الصافات': 182, 'ص': 88, 'الزمر': 75, 'غافق': 85,
  ...
  'التكوير': 29, 'الإنفطار': 19, 'المطففين': 36, 'الانشقاق': 25, 'البروج': 22,
  ...
  'القارعة': 11, 'التكاثر': 8, 'الماعون': 7, 'الكوثر': 3, 'الكافرون': 6,
  'النصر': 3, 'المسد': 5, 'الإخلاص': 4, 'الفلق': 5, 'الناس': 6,
};

export const SURAH_LIST = Object.keys(SURAH_VERSES);

export const getSurahVerseCount = (surahName) => {
  return SURAH_VERSES[surahName] || 0;
};

export const isSurahExists = (surahName) => {
  return surahName in SURAH_VERSES;
};

export const getTotalQuranVerses = () => {
  return Object.values(SURAH_VERSES).reduce((sum, verses) => sum + verses, 0);
};
